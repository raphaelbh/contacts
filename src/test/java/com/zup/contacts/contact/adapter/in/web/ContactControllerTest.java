...
class ContactControllerTest {
    ...
    void createContact() throws Exception {
        ...
        when(contactResponseMapper.domainToResponse(any(ContactDomain.class))).thenReturn(contactResponse);
    ...
    void listContacts() throws Exception {
        ...
        when(contactResponseMapper.domainToResponse(any(List.class))).thenReturn(Arrays.asList(contactResponse));
